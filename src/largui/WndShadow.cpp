...
CWndShadow::CWndShadow(void)
	...
	, m_ShadowShowMode(noEx)//设置哪一边的阴影不需要显示
{
...
{
	// 固定使用 100% 缩放，保证在不同 Windows 显示缩放下 UI 呈现一致
	return 1.0f;
}
